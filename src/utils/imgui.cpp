...
#include <common/imgui/fs_imgui_image.bin.h>
#include <common/imgui/fs_ocornut_imgui.bin.h>
#include <common/imgui/vs_imgui_image.bin.h>
#include <common/imgui/vs_ocornut_imgui.bin.h>

#include <common/fonts/icons_font_awesome.ttf.h>
#include <common/fonts/icons_kenney.ttf.h>
...
struct OcornutImguiContext
{
    void render(ImDrawData *_drawData)
    {
        ...
        for (int32_t ii = 0, num = _drawData->CmdListsCount; ii < num; ++ii)
        {
            ...
            if (!shift::checkAvailTransientBuffers(numVertices, m_layout, numIndices))
            {
    ...
    void create(GLFWwindow* _window, float _fontSize, bx::AllocatorI *_allocator)
    {
        ...
        m_imageProgram =
            bgfx::createProgram(bgfx::createEmbeddedShader(s_embeddedShaders, type, "vs_imgui_image"),
