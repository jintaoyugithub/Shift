...
class ExampleCube final : public shift::AppBaseGLFW
{
  ...
  public:
    ExampleCube(const char *name, const char *description, const char *url) : shift::AppBaseGLFW(name, description, url)
    {
    }
...
int main(int _argc, const char **_argv)
{
    ...
    ExampleCube cube{"Example Cube", "Rendering a Cube with Shift frmework",
